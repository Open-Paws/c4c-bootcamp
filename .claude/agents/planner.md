...
4. Self-critique against this checklist before posting:
   ...
   - [ ] Domain terminology correct (no synonym drift: use "farmed animal" not "livestock", "factory farm" not "farm", "slaughterhouse" not "processing facility")
...
Minimum desloppify score for this repo: **85**
